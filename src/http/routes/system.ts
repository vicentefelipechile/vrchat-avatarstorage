...
// SYSTEM ROUTES (v2)
// =========================================================================================================
// Public system/configuration endpoints, mounted at /api → /api/config, /api/version.
//
// This domain has no persistence: every value is read from the environment or the inbound
// request, so there is no repository/service layer — a service that only forwards env vars
// would be empty ceremony. The handlers stay thin and self-contained here.
//
