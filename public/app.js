...
const translations = {
    es: {
        ...
        upload: { title: 'Subir Recurso', name: 'Título', desc: 'Descripción', cat: 'Categoría', file: 'Archivo', btn: 'Subir', success: 'Subido correctamente', thumbnail: 'Miniatura (Thumbnail)', reference: 'Imagen de Referencia', mainFile: 'Archivo Principal', preview: 'Vista Previa', optional: 'Opcional', required: '*', uploading: 'Subiendo archivos...', uploadingThumbnail: 'Subiendo miniatura...', uploadingReference: 'Subiendo imagen de referencia...', uploadingFile: 'Subiendo archivo principal...', creating: 'Creando recurso...', error: 'Error', fileTypes: 'Solo archivos RAR, ZIP o UnityPackage', imageVideo: 'Imagen o video para la vista previa', imageVideoAdditional: 'Imagen o video adicional', validFile: 'archivo válido', invalidFile: 'Archivo inválido', markdownPlaceholder: 'Escribe la descripción usando Markdown...', noContent: 'Sin contenido', resourceName: 'Nombre del recurso', errorMainFile: 'El archivo principal debe ser .rar, .zip o .unitypackage', errorThumbnail: 'Debes seleccionar una miniatura', errorThumbnailUpload: 'Error al subir miniatura', errorReferenceUpload: 'Error al subir imagen de referencia', errorFileUpload: 'Error al subir archivo principal', errorCreateResource: 'Error al crear recurso', errorUnknown: 'Error desconocido', errorCaptcha: 'Por favor completa el CAPTCHA' },
    ...
    en: {
        ...
        upload: { title: 'Upload Resource', name: 'Title', desc: 'Description', cat: 'Category', file: 'File', btn: 'Upload', success: 'Upload successful', thumbnail: 'Thumbnail', reference: 'Reference Image', mainFile: 'Main File', preview: 'Preview', optional: 'Optional', required: '*', uploading: 'Uploading files...', uploadingThumbnail: 'Uploading thumbnail...', uploadingReference: 'Uploading reference image...', uploadingFile: 'Uploading main file...', creating: 'Creating resource...', error: 'Error', fileTypes: 'RAR, ZIP or UnityPackage files only', imageVideo: 'Image or video for preview', imageVideoAdditional: 'Additional image or video', validFile: 'valid file', invalidFile: 'Invalid file', markdownPlaceholder: 'Write description using Markdown...', noContent: 'No content', resourceName: 'Resource name', errorMainFile: 'Main file must be .rar, .zip or .unitypackage', errorThumbnail: 'You must select a thumbnail', errorThumbnailUpload: 'Error uploading thumbnail', errorReferenceUpload: 'Error uploading reference image', errorFileUpload: 'Error uploading main file', errorCreateResource: 'Failed to create resource', errorUnknown: 'Unknown error', errorCaptcha: 'Please complete the CAPTCHA' },
    ...
    ru: {
        ...
        upload: { title: 'Загрузить Ресурс', name: 'Название', desc: 'Описание', cat: 'Категория', file: 'Файл', btn: 'Загрузить', success: 'Успешно загружено', thumbnail: 'Миниатюра', reference: 'Изображение для справки', mainFile: 'Основной файл', preview: 'Предпросмотр', optional: 'Необязательно', required: '*', uploading: 'Загрузка файлов...', uploadingThumbnail: 'Загрузка миниатюры...', uploadingReference: 'Загрузка изображения для справки...', uploadingFile: 'Загрузка основного файла...', creating: 'Создание ресурса...', error: 'Ошибка', fileTypes: 'Только файлы RAR, ZIP или UnityPackage', imageVideo: 'Изображение или видео для предпросмотра', imageVideoAdditional: 'Дополнительное изображение или видео', validFile: 'действительный файл', invalidFile: 'Недопустимый файл', markdownPlaceholder: 'Написать описание используя Markdown...', noContent: 'Нет содержимого', resourceName: 'Название ресурса', errorMainFile: 'Основной файл должен быть .rar, .zip или .unitypackage', errorThumbnail: 'Вы должны выбрать миниатюру', errorThumbnailUpload: 'Ошибка загрузки миниатюры', errorReferenceUpload: 'Ошибка загрузки изображения', errorFileUpload: 'Ошибка загрузки файла', errorCreateResource: 'Ошибка создания ресурса', errorUnknown: 'Неизвестная ошибка', errorCaptcha: 'Пожалуйста, пройдите CAPTCHA' },
    ...
    jp: {
        ...
        upload: { title: 'リソースをアップロード', name: 'タイトル', desc: '説明', cat: 'カテゴリー', file: 'ファイル', btn: 'アップロード', success: 'アップロード成功', thumbnail: 'サムネイル', reference: '参照画像', mainFile: 'メインファイル', preview: 'プレビュー', optional: 'オプション', required: '*', uploading: 'ファイルをアップロード中...', uploadingThumbnail: 'サムネイルをアップロード中...', uploadingReference: '参照画像をアップロード中...', uploadingFile: 'メインファイルをアップロード中...', creating: 'リソースを作成中...', error: 'エラー', fileTypes: 'RAR、ZIP、UnityPackageファイルのみ', imageVideo: 'プレビュー用の画像または動画', imageVideoAdditional: '追加の画像または動画', validFile: '有効なファイル', invalidFile: '無効なファイル', markdownPlaceholder: 'Markdownで説明を書く...', noContent: 'コンテンツなし', resourceName: 'リソース名', errorMainFile: 'メインファイルは .rar、.zip、または .unitypackage である必要があります', errorThumbnail: 'サムネイルを選択する必要があります', errorThumbnailUpload: 'サムネイルのアップロードエラー', errorReferenceUpload: '参照画像のアップロードエラー', errorFileUpload: 'ファイルのアップロードエラー', errorCreateResource: 'リソースの作成エラー', errorUnknown: '不明なエラー', errorCaptcha: 'CAPTCHAを完了してください' },
    ...
    cn: {
        ...
        upload: { title: '上传资源', name: '标题', desc: '描述', cat: '类别', file: '文件', btn: '上传', success: '上传成功', thumbnail: '缩略图', reference: '参考图片', mainFile: '主文件', preview: '预览', optional: '可选', required: '*', uploading: '上传文件中...', uploadingThumbnail: '上传缩略图中...', uploadingReference: '上传参考图片中...', uploadingFile: '上传主文件中...', creating: '创建资源中...', error: '错误', fileTypes: '仅限 RAR、ZIP 或 UnityPackage 文件', imageVideo: '预览用图片或视频', imageVideoAdditional: '附加图片或视频', validFile: '有效文件', invalidFile: '无效文件', markdownPlaceholder: '使用 Markdown 编写描述...', noContent: '无内容', resourceName: '资源名称', errorMainFile: '主文件必须是 .rar、.zip 或 .unitypackage', errorThumbnail: '您必须选择缩略图', errorThumbnailUpload: '上传缩略图错误', errorReferenceUpload: '上传参考图片错误', errorFileUpload: '上传主文件错误', errorCreateResource: '创建资源错误', errorUnknown: '未知错误', errorCaptcha: '请完成验证码' },
    ...
    fr: {
        ...
        upload: { title: 'Télécharger une ressource', name: 'Titre', desc: 'Description', cat: 'Catégorie', file: 'Fichier', btn: 'Télécharger', success: 'Téléchargement réussi', thumbnail: 'Miniature', reference: 'Image de référence', mainFile: 'Fichier principal', preview: 'Aperçu', optional: 'Facultatif', required: '*', uploading: 'Téléchargement des fichiers...', uploadingThumbnail: 'Téléchargement de la miniature...', uploadingReference: 'Téléchargement de l\'image de référence...', uploadingFile: 'Téléchargement du fichier principal...', creating: 'Création de la ressource...', error: 'Erreur', fileTypes: 'Fichiers RAR, ZIP ou UnityPackage uniquement', imageVideo: 'Image ou vidéo pour l\'aperçu', imageVideoAdditional: 'Image ou vidéo supplémentaire', validFile: 'fichier valide', invalidFile: 'Fichier invalide', markdownPlaceholder: 'Écrire la description en Markdown...', noContent: 'Pas de contenu', resourceName: 'Nom de la ressource', errorMainFile: 'Le fichier principal doit être .rar, .zip ou .unitypackage', errorThumbnail: 'Vous devez sélectionner une miniature', errorThumbnailUpload: 'Erreur de téléchargement de la miniature', errorReferenceUpload: 'Erreur de téléchargement de l\'image de référence', errorFileUpload: 'Erreur de téléchargement du fichier principal', errorCreateResource: 'Erreur de création de la ressource', errorUnknown: 'Erreur inconnue', errorCaptcha: 'Veuillez compléter le CAPTCHA' },
                ...
                <form id="upload-form">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="reference-image" accept="image/png,image/jpg,image/jpeg,video/mp4,video/webm">
    ...
    async postRender() {
        ...
        referenceInput.addEventListener('change', (e) => {
            ...
            if (file) {
                ...
                const url = URL.createObjectURL(file);
                if (isVideo) {
                    referencePreview.innerHTML = `<video src="${url}" style="max-width: 200px; max-height: 200px;" controls></video>`;
                } else {
                    referencePreview.innerHTML = `<img src="${url}" style="max-width: 200px; max-height: 200px;">`;
                }
            }
        });
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                let referenceImageUuid = null;
                if (referenceImage) {
                    btn.textContent = t('upload.uploadingReference');
                    const referenceFormData = new FormData();
                    referenceFormData.append('file', referenceImage);
                    referenceFormData.append('media_type', referenceImage.type.startsWith('video/') ? 'video' : 'image');
                    ...
                    if (!referenceRes.ok) throw new Error(t('upload.errorReferenceUpload'));
                    const referenceData = await referenceRes.json();
                    referenceImageUuid = referenceData.media_uuid;
                }
                ...
                const resourceBody = {
                    ...
                    reference_image_uuid: referenceImageUuid,
                    media_files: [fileData.media_uuid],
                    links: [{
