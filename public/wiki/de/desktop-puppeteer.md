...
- **Software:** [Microsoft .NET 9.0 Desktop Runtime](https://dotnet.microsoft.com/download/dotnet/9.0) auf deinem PC installiert.
  - *Download-Anleitung:* Wenn du auf den Link klickst, suche den Abschnitt „**.NET Desktop Runtime**". In der kleinen Tabelle darunter, in der Zeile „Windows", klicke auf den **x64**-Link, um den Installer herunterzuladen.
