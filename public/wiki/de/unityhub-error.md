...
> [!WARNING]
> Warnung
> Für diesen Schritt musst du den **offiziellen Windows-Deinstallierer** verwenden (über _Einstellungen -> Apps_ oder _Systemsteuerung_). Verwende **KEINE Drittanbieter-Programme** wie IObit Uninstaller, Revo Uninstaller usw., da diese notwendige Registry-Schlüssel löschen und das Problem verschlimmern können.
...
_(Hinweis: Du kannst den `%USERPROFILE%`-Pfad direkt in die Explorer-Leiste kopieren und einfügen, genau wie du `%appdata%` zum Installieren von Minecraft-Mods verwenden würdest, und es wird dich automatisch zu deinem aktuellen Benutzerordner führen)._
