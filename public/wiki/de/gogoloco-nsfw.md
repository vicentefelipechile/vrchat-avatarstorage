...
2. **Bei manueller Integration in den Avatar:**
   ...
   - _(Optional)_ Wenn du keine anderen Avatare mit normalem GoGo Loco in diesem Projekt hast, lösche den `GoGo`-Ordner aus deinen `Assets`.
...
LastationVRChat. (n.d.). _NSFW Locomotion_ [Computer software]. GitHub. https://github.com/LastationVRChat/NSFW-Locomotion

Reddit User. (n.d.). _Help! How do i remove gogoloco from my avatar?_ [Online forum post]. Reddit. https://www.reddit.com/r/VRchat/comments/17b1n2e/help_how_do_i_remove_gogoloco_from_my_avatar/
