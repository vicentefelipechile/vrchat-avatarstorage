...
- Leise Alternative für Nutzer, die kein Mikrofon verwenden möchten
...
- **Verwendetes System:** Contact Receiver
- **Sync-Parameter:** 4 Parameter (verbraucht 18 Speicher)
- **Audio-Clips:** 32 verlustbehaftet komprimierte Audio-Clips
- **Menü:** 1 Menü für Bool-Steuerung
- **Constraint:** 1 Constraint

> [!NOTE]
> Erfordert [Modular Avatar](/wiki?topic=modular-avatar) für die Parameter-Einrichtung. Für manuelle Installation nicht erforderlich.
...
1. Füge das **KissSFX**-Prefab zur Hierarchie deines Avatars hinzu
2. Positioniere das **CenterOfHead**-Objekt:
   - Der Gizmo (Mittelpunkt) sollte an der **Nasenspitze** oder zwischen Nase und Mund platziert werden
3. In den [Modular Avatar](/wiki?topic=modular-avatar)-Einstellungen kannst du ändern, wo das Toggle-Menü installiert wird

> [!TIP]
> Wenn du einen WD (World Disabled) Off Avatar verwendest, gibt es ein spezielles Paket auf BOOTH, das Prefabs für die manuelle Installation enthält.
