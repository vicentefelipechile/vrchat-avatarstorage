...
> [!WARNING]
> Ostrzeżenie
> W tym kroku musisz użyć **oficjalnego deinstalatora Windows** (z *Ustawienia -> Aplikacje* lub *Panel sterowania*). **NIE używaj programów firm trzecich** jak IObit Uninstaller, Revo Uninstaller itp.
