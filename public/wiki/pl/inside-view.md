...
- **Łatwa Instalacja:** Kompatybilne z **VRCFury** — drag-and-drop.

## Instalacja

1. Zaimportuj `.unitypackage` **Inside View**.
2. Przeciągnij prefab do hierarchii awatara jako dziecko bone'a z otworem.
3. Wyrównaj z obiektem SPS Socket.
4. Przy przesyłaniu VRCFury automatycznie wszystko scali.

- **Koszt Parametrów:** Wersja "Full" używa do 35 bitów, "Standard" około 17 [1].
