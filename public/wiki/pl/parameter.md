...
- **Nieefektywny Sposób (Bool):** Tworzysz 10 parametrów `Bool`. _Koszt:_ 10 bitów.
- **Efektywny Sposób (Int):** Tworzysz **1** parametr `Int` o nazwie `Top_Clothing`. _Koszt:_ 8 bitów — i możesz mieć do **255 koszulek**!
