...
1.  **Исчерпание Параметров (Parameter Exhaustion):**
    ...
    - _Последствие:_ VRChat заблокирует загрузку аватара, или последние установленные компоненты не будут работать.
...
- **Неэффективный способ (Bools):** Вы создаете 10 параметров `Bool` (Shirt1, Shirt2... Shirt10).
  - _Стоимость:_ 10 Бит.
  - _Недостаток:_ Вы тратите 1 бит на каждую дополнительную вещь.
- **Эффективный способ (Int):** Вы создаете **1** параметр `Int` под названием `Top_Clothing`.
  - _Стоимость:_ 8 Бит (всегда, так как это Int).
  - _Преимущество:_ Вы можете иметь до **255 рубашек**, используя те же 8 бит!
  - _Как это работает:_ В Animator вы настраиваете: если значение 1 — активируется Рубашка А, если 2 — Рубашка Б и т.д.
...
- VRChat. (н.д.). Expression Parameters. VRChat Documentation. https://creators.vrchat.com/avatars/animator-parameters/#expression-parameters-asset
- VRChat. (н.д.). Avatar Parameter Driver. VRChat Documentation. https://creators.vrchat.com/avatars/state-behaviors/#avatar-parameter-driver
- VRChat. (н.д.). OSC Overview. VRChat Documentation. https://creators.vrchat.com/avatars/osc/
- Franada. (н.д.). GoGo Loco Documentation. https://github.com/Franada/goloco
- VRCFury. (н.д.). SPS - Super Plug Shader. VRCFury Documentation. https://vrcfury.com/sps
