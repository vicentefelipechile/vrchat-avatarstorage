...
Modular Avatar. (s. f.). _Modular Avatar_. Nadena Dev. Recuperado de https://modular-avatar.nadena.dev/

Modular Avatar. (s. f.). _Tutorials_. Nadena Dev. Recuperado de https://modular-avatar.nadena.dev/docs/tutorials

bd\_. (2026). _bdunderscore/modular-avatar_ [Software]. GitHub. Recuperado de https://github.com/bdunderscore/modular-avatar
