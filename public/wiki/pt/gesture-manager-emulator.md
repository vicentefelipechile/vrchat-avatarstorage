...
1. Descarregue o arquivo `.unitypackage` a partir da seção de _Releases_ no GitHub de BlackStartx ou da sua página no BOOTH [3].
...
- **Teste de Contactos:** Permite ativar _VRCContacts_ clicando sobre eles com o rato.
