...
> [!WARNING]
> Warning
> For this step, you must use the **official Windows uninstaller** (from _Settings -> Apps_ or _Control Panel_). **DO NOT use third-party programs** like IObit Uninstaller, Revo Uninstaller, etc., as they can delete necessary registry keys and worsen the problem.
...
_(Note: You can copy and paste the `%USERPROFILE%` path directly into the explorer bar, just like you would use `%appdata%` to install Minecraft mods, and it will automatically take you to your current user folder)._
