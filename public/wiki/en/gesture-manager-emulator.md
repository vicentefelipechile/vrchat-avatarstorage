...
1. Download the `.unitypackage` file from the _Releases_ section on BlackStartx's GitHub or from his BOOTH page [3].
...
- **Contacts Testing:** Allows you to trigger _VRCContacts_ by clicking on them with the mouse.
