...
> [!WARNING]
> Gebruik voor deze stap de **officiële Windows-verwijderaar** (via _Instellingen -> Apps_ of _Configuratiescherm_). **Gebruik GEEN programma's van derden** zoals IObit Uninstaller, Revo Uninstaller, enz.
