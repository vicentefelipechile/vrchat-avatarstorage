...
- **Inefficiënt (Bool):** 10 `Bool`-parameters. _Kosten:_ 10 bits.
- **Efficiënt (Int):** 1 `Int`-parameter genaamd `Top_Clothing`. _Kosten:_ 8 bits — en je kunt tot **255 shirts** hebben!
