...
> [!NOTE]
> VRCQuestTools werkt via het **Non-Destructive Modular Framework (NDMF)**.
...
4. Ga naar **File** → **Build Settings** → Selecteer **Android** → **Switch Platform**
5. Upload de geconverteerde avatar
