...
- **Eenvoudige Installatie:** Compatibel met **VRCFury** — drag-and-drop.

## Installatie

1. Importeer het `.unitypackage` van **Inside View**.
2. Sleep de prefab naar de hiërarchie als kind van het bot met de opening.
3. Lijn uit met het SPS Socket-object.
4. VRCFury voegt alles automatisch samen bij het uploaden.

- **Parameterkosten:** "Full"-versie gebruikt tot 35 bits, "Standard" ongeveer 17.
