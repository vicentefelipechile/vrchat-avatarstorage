...
- **Rendering:** Geavanceerde opties zoals Backface Culling, Stencil, Z-Buffer voor transparantie- en layering-effecten.
...
> [!WARNING]
> Meng **Poiyomi Free** en **Poiyomi Pro** niet in hetzelfde project. Kies er één en verwijder de andere om conflicten te voorkomen.
...
> [!TIP]
> Als Poiyomi er "vergrendeld" uitziet (met een hangslot bovenaan), is het materiaal in geoptimaliseerde modus. Klik op het hangslot om het te ontgrendelen en te bewerken.
