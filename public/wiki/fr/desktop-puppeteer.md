...
- **Logiciel :** [Microsoft .NET 9.0 Desktop Runtime](https://dotnet.microsoft.com/download/dotnet/9.0) installé sur votre PC.
  - _Comment télécharger :_ Lorsque vous cliquez sur le lien, cherchez la section intitulée "**\.NET Desktop Runtime**". Dans le petit tableau en dessous, sur la ligne "Windows", cliquez sur le lien "**x64**" pour télécharger le programme d'installation.
...
- Esska. (s.d.). Esska Desktop Puppeteer. BOOTH. https://esska.booth.pm/items/6366670
