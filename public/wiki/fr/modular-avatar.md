...
Modular Avatar. (s. f.). *Modular Avatar*. Nadena Dev. Récupéré de https://modular-avatar.nadena.dev/

Modular Avatar. (s. f.). *Tutorials*. Nadena Dev. Récupéré de https://modular-avatar.nadena.dev/docs/tutorials

bd_. (2026). *bdunderscore/modular-avatar* [Logiciel]. GitHub. Récupéré de https://github.com/bdunderscore/modular-avatar
