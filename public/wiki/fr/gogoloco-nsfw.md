...
2. **Si intégré manuellement dans l'avatar :**
   ...
   - _(Facultatif)_ Si aucun autre avatar n'utilise GoGo Loco dans ce projet, supprimez le dossier `GoGo` de vos `Assets`.
...
LastationVRChat. (s.d.). _NSFW Locomotion_ [Logiciel informatique]. GitHub. https://github.com/LastationVRChat/NSFW-Locomotion

Utilisateur Reddit. (s.d.). _Help! How do i remove gogoloco from my avatar?_ [Message sur un forum en ligne]. Reddit. https://www.reddit.com/r/VRchat/comments/17b1n2e/help_how_do_i_remove_gogoloco_from_my_avatar/
