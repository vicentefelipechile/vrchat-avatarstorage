...
1. Téléchargez le fichier `.unitypackage` depuis la section _Releases_ du GitHub de BlackStartx ou depuis sa page sur BOOTH [3].
...
- **Test de Contacts :** Permet d'activer les _VRCContacts_ en cliquant dessus avec la souris.
...
- VRChat. (s.d.). VCC Documentation. VRChat Creator Companion. https://vcc.docs.vrchat.com
- BlackStartx. (s.d.). Gesture Manager. Booth. https://blackstartx.booth.pm/items/3922472
