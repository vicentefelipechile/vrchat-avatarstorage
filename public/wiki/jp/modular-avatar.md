...
Modular Avatar. (s. f.). _Modular Avatar_. Nadena Dev. https://modular-avatar.nadena.dev/ より取得

Modular Avatar. (s. f.). _Tutorials_. Nadena Dev. https://modular-avatar.nadena.dev/docs/tutorials より取得

bd\_. (2026). _bdunderscore/modular-avatar_ [ソフトウェア]. GitHub. https://github.com/bdunderscore/modular-avatar より取得
