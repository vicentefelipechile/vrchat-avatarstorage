...
> [!WARNING]
> Bu adım için **resmi Windows kaldırıcısını** kullanmalısınız (*Ayarlar -> Uygulamalar* veya *Denetim Masası*). IObit Uninstaller, Revo Uninstaller gibi **üçüncü taraf programları KULLANMAYIN**.
