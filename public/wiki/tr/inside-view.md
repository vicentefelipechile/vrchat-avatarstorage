...
- **Kolay Kurulum:** **VRCFury** ile uyumlu — sürükle-bırak.

## Kurulum

1. **Inside View**'ın `.unitypackage`'ını içe aktarın.
2. Prefab'ı hiyerarşide açıklığın bulunduğu kemiğin çocuğu olarak sürükleyin.
3. SPS Socket nesnesiyle hizalayın.
4. Yüklemede VRCFury her şeyi otomatik birleştirir.

- **Parametre Maliyeti:** "Full" sürümü 35 bit'e kadar, "Standard" yaklaşık 17 bit.
