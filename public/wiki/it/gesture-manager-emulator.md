...
1. Scarica il file `.unitypackage` dalla sezione _Releases_ sul GitHub di BlackStartx o dalla sua pagina BOOTH [3].
...
- **Test Contacts:** Permette di attivare i _VRCContacts_ cliccandoci sopra con il mouse.
