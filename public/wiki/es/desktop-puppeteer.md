...
- **Software:** [Microsoft .NET 9.0 Desktop Runtime](https://dotnet.microsoft.com/es-es/download/dotnet/9.0) instalado en tu PC.
  - _Cómo descargar:_ Al entrar al enlace, busca la sección que dice "**Entorno de ejecución de escritorio de .NET**" (o ".NET Desktop Runtime" si está en inglés). En la pequeña tabla debajo, en la fila de "Windows", haz clic en el enlace que dice "**x64**" para descargar el instalador.
