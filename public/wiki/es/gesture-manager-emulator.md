...
1. Descarga el archivo `.unitypackage` desde la sección de _Releases_ en el GitHub de BlackStartx o desde su página en BOOTH [3].
...
- **Prueba de Contactos:** Permite activar _VRCContacts_ haciendo clic sobre ellos con el ratón.
