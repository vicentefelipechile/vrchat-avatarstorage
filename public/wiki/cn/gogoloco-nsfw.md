...
2. **如果手动集成到虚拟形象中：**
   ...
   - _(可选)_ 如果该项目中没有使用普通 GoGo Loco 的其他虚拟形象，请从 `Assets` 中删除 `GoGo` 文件夹。
...
LastationVRChat. (n.d.). _NSFW Locomotion_ [计算机软件]. GitHub. https://github.com/LastationVRChat/NSFW-Locomotion

Reddit 用户. (n.d.). _Help! How do i remove gogoloco from my avatar?_ [在线论坛帖子]. Reddit. https://www.reddit.com/r/VRchat/comments/17b1n2e/help_how_do_i_remove_gogoloco_from_my_avatar/
