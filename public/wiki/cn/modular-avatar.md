...
Modular Avatar. (n.d.). *Modular Avatar*. Nadena Dev. 取自 https://modular-avatar.nadena.dev/

Modular Avatar. (n.d.). *Tutorials*. Nadena Dev. 取自 https://modular-avatar.nadena.dev/docs/tutorials

bd_. (2026). *bdunderscore/modular-avatar* [软件]. GitHub. 取自 https://github.com/bdunderscore/modular-avatar
