...
export default {
	...
	admin: {
		...
		communityAds: {
			title: 'Annunci della comunità',
			tabPending: 'In attesa di revisione',
			tabActive: 'Annunci attivi',
			tabSlots: 'Configurazione slot',
			tabStats: 'Statistiche (7g)',
			approve: 'Approva',
			reject: 'Rifiuta',
			...
			saveSlot: 'Salva',
			colAd: 'Annuncio',
			colType: 'Tipo di servizio',
			colDest: 'Destinazione',
			colSlot: 'Slot',
			colMaxConcurrent: 'Max simultanei',
			colRotationHours: 'Rotazione (ore)',
			colEnabled: 'Abilitato',
			colImpressions: 'Impressioni',
			colClicks: 'Clic',
			noAds: 'Nessun annuncio in questo stato.',
			noStats: 'Nessuna statistica ancora.',
			statsNote: 'Mostra impressioni e clic aggregati degli ultimi 7 giorni.',
			rejectReasonPrompt: 'Inserisci il motivo del rifiuto:',
			confirmDeactivate: 'Disattivare questo annuncio?',
			toastApproved: 'Annuncio approvato.',
			toastRejected: 'Annuncio rifiutato.',
			toastDeactivated: 'Annuncio disattivato.',
			toastWeightSaved: 'Peso aggiornato.',
			toastSlotSaved: 'Configurazione slot aggiornata.',
			preview: 'Anteprima',
	...
	item: {
		...
		md: {
			...
			previewEmpty: 'Niente da visualizzare ancora.',
		},
	...
	dmca: {
		...
		simple: {
			...
			reporterNamePlaceholder: 'Il tuo nome o alias...',
			bodyThirdReporterReason: 'Motivo della segnalazione',
			of: 'di',
			...
			bodyI: 'Io,',
			bodyClaim: 'dichiaro che la risorsa ospitata su vrcstorage.lat',
			bodyInfringe: 'vÃ¬ola',
		...
		advanced: {
			intro: 'Scrivi il tuo avviso DMCA in linguaggio professionale. Assicurati di includere tutte le informazioni richieste.',
			claimLabel: 'Reclamo (in linguaggio professionale):',
			claimPlaceholder: 'Io, [il tuo nome], a nome di [azienda/persona], notifica che il contenuto in violazione...',
			resourcesLabel: 'Risorsa/e in Violazione:',
			resourcesHint: 'Incolla gli URL delle risorse in violazione (uno per riga):',
			evidenceLabel: 'Prova di Proprietà:',
			evidenceHint: 'URL o descrizione che prova la tua proprietà del contenuto originale:',
			evidencePlaceholder: 'https://link-to-your-original-work.com o descrizione...',
		},
	},
	blog: {
		title: 'Blog',
		...
		excerptLabel: 'Estratto (opzionale)',
		coverImageLabel: 'Immagine di copertina (opzionale)',
		authorDisplayLabel: 'Pubblica come',
		authorPersonal: 'Il mio nome utente',
		authorTeam: 'VRCStorage Team',
		savePost: 'Salva articolo',
		comments: 'Commenti',
	...
	meta: {
		...
		features: {
			...
			physbones: 'PhysBones',
			dps: 'DPS',
			facetracking: 'Tracciamento Facciale',
			gogoloco: 'GoGo Loco',
			toggles: 'Interruttori',
			questOptimized: 'Ottimizzato per Quest',
		},
		avatar: {
			...
			extras: 'Extra avatar',
			authorLinked: 'UUID Autore collegato',
		},
		asset: {
		...
		asset_type: {
			...
			prop: 'Prop',
			shader: 'Shader',
			particle: 'Effetto Particelle',
			vfx: 'VFX',
			prefab: 'Prefab',
			script: 'Script',
			animation: 'Animazione',
			avatarBase: 'Base Avatar',
			texturePack: 'Pacchetto Texture',
			sound: 'Suono',
			tool: 'Strumento',
			hud: 'HUD',
			other: 'Altro',
	...
	sort: {
		newest: 'Più recenti',
		mostDownloaded: 'Più vecchi',
		aZ: 'A-Z',
	},
	filterPanel: {
		noAssets: 'Nessun asset trovato con questi filtri.',
		noAvatars: 'Nessun avatar trovato con questi filtri.',
		prev: 'Precedente',
		next: 'Successivo',
		pagePrefix: 'Pagina',
		assetCountStr: 'asset',
		avatarCountStr: 'avatar',
		clothesCountStr: 'indumento/i',
		sortLabel: 'Ordina per',
		titleAssets: 'VRCStorage — Asset',
		titleAvatars: 'VRCStorage — Avatar',
		titleClothes: 'VRCStorage — Abbigliamento',
		filterTitle: 'Filtri',
		reset: 'Reimposta filtri',
	},
	autorProfile: {
		notFound: 'Non esiste nessun autore con questo nome.',
		notFoundTitle: 'Autore non trovato',
		noResources: 'Questo autore non ha ancora risorse correlate.',
		avatarsTitle: 'Avatar',
	},
	community: {
		badge: 'Comunità',
		visitProfile: 'Vedi profilo',
		visitWebsite: 'Visita il sito',
		by: 'Di',
		serviceTypes: {
			avatar_creator: 'Creatore di avatar',
			'3d_artist': 'Artista 3D',
			illustrator: 'Illustratore',
			world_builder: 'Costruttore di mondi',
			texture_artist: 'Artista di texture',
			rigger: 'Rigger',
			shader_dev: 'Sviluppatore shader',
			animator: 'Animatore',
			voice_actor: 'Doppiatore',
			commissioner: 'Commissionario',
		},
		directory: {
			title: 'Comunità',
			subtitle: 'Scopri creator e servizi VRChat',
			allTypes: 'Tutti i tipi',
			searchPlaceholder: 'Cerca per nome...',
			noAds: 'Ancora nessuna promozione della comunità.',
			submitAd: 'Promuoviti',
			loginToSubmit: 'Accedi per promuovere i tuoi servizi.',
		},
		detail: {
			notFound: 'Questa pagina di promozione non è stata trovata.',
			createTitle: 'Promuoviti',
			editTitle: 'Modifica promozione',
		},
		budget: {
			btnLabel: 'Ho un budget per gli annunci',
			title: 'Questa è una piattaforma gratuita.',
			body: 'VRCStorage non accetta denaro per i posizionamenti pubblicitari. Tutte le promozioni sono guidate dalla comunità e gratuite. Se vuoi che il tuo lavoro venga visto, invialo semplicemente — verrà esaminato come tutti gli altri.',
			ok: 'Capito!',
		},
		prefs: {
			title: 'Preferenze annunci',
			close: 'Chiudi',
			showAds: 'Mostra promozioni della comunità',
			slotsTitle: 'Zone di posizionamento',
			typesTitle: 'Tipi di servizio',
			adjust: 'Regola',
			slotSidebar: 'Banner laterale',
			slotFeatured: 'Artista in evidenza',
			slotGrid: 'Scheda griglia',
			slotDetail: 'Banner pagina articolo',
		},
		form: {
			title: 'Nome visualizzato',
			titlePlaceholder: 'Il tuo nome o brand...',
			tagline: 'Slogan',
			taglinePlaceholder: 'Cosa fai? (max 80 caratteri)',
			serviceType: 'Tipo di servizio',
			destType: 'Destinazione',
			destInternal: 'Pagina interna (VRCStorage)',
			destExternal: 'Link esterno',
			externalUrl: 'URL esterna',
			description: 'Contenuto della pagina (Markdown)',
			descriptionHint: 'Mostrato sulla tua pagina profilo interna. Supporta Markdown.',
			descriptionPlaceholder: 'Racconta alle persone del tuo lavoro...',
			bannerImage: 'Immagine banner',
			bannerImageHint: 'Immagine verticale alta, usata nelle barre laterali (consigliato 160×196).',
			cardImage: 'Immagine scheda',
			cardImageHint: 'Immagine orizzontale larga, usata nelle griglie (consigliato 400×300).',
			noImage: 'Nessuna immagine',
			uploadBanner: 'Carica banner',
			uploadCard: 'Carica immagine scheda',
			uploading: 'Caricamento...',
			uploadError: 'Caricamento fallito.',
			submit: 'Invia per revisione',
			save: 'Salva modifiche',
			submitting: 'Invio in corso...',
			submitSuccess: 'Inviato! La tua promozione è in revisione.',
			updateSuccess: 'Aggiornato con successo.',
			updatedPendingReview: 'Aggiornato. Reinviato per revisione.',
			errorTitle: 'Il nome visualizzato è obbligatorio.',
			errorTagline: 'Lo slogan è obbligatorio.',
			errorServiceType: 'Seleziona un tipo di servizio.',
			errorExternalUrl: 'L\'URL esterna è obbligatoria.',
		},
	},
};
