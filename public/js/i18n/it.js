...
export default {
	...
	dmca: {
		title: 'Avviso DMCA', subtitle: 'Segnala una violazione del copyright di risorse ospitate su vrcstorage.lat',
		modeSimple: 'Modalità semplice', modeAdvanced: 'Modalità avanzata', sendEmail: 'Invia via Email',
		simple: {
			intro: 'Compila le opzioni seguenti per generare il tuo reclamo:',
			iAmA: 'Io, in qualità di', optAuthor: "L'Autore", optRepresentative: 'Rappresentante',
			optThirdReporter: 'Terza parte (non proprietario)',
			reporterName: 'Identificato come', reporterNamePlaceholder: 'Il tuo nome o pseudonimo...',
			reporterReason: 'Motivo della segnalazione', reporterReasonPlaceholder: 'Descrivi la situazione in dettaglio...',
			reason_recognized: 'Riconosco questo contenuto come opera di un altro creatore',
			reason_shared: "Il contenuto è stato condiviso senza il permesso dell'autore originale",
			...
			reason_other: 'Altro', bodyThirdReporterReason: 'Motivo della segnalazione',
			representing: "dell'organizzazione / studio", companyPlaceholder: "Nome dell'azienda...", of: 'di',
			claimThat: 'dichiaro che la risorsa viola', optMyRights: "i miei diritti d'autore",
			optThirdParty: "i diritti d'autore di un'altra persona",
			originalOwner: 'che è riconosciuto come', ownerPlaceholder: 'Nome del creatore originale...',
			recognizedAs: 'riconosciuto come', andDemand: 'e richiedo',
			optImmediateTermination: 'Terminazione immediata della risorsa',
			optImmediateRemoval: 'Rimozione immediata della risorsa',
			optNotifyUser: "Notifica all'utente responsabile",
			resourceUrl: 'URL della risorsa in violazione:', resourceUrls: 'Risorsa/e in violazione:',
			resourceUrlsHint: 'Un link per riga.',
			proofLabel: 'Prova di autenticità (opzionale):',
			proofHint: "Link all'opera originale o altra prova della tua proprietà.",
			proofPlaceholder: 'https://link-opera-originale.com o descrizione...',
			preview: 'Anteprima reclamo:', urlNotSpecified: '(URL non specificato)',
			bodyI: 'Io,', bodyClaim: 'dichiaro che la risorsa ospitata su "vrcstorage.lat"', bodyInfringe: 'viola',
			bodyThirdReporterClaim: 'sto segnalando una possibile violazione del copyright nella risorsa specificata.',
			bodyDemand: 'Pertanto, richiedo:', bodyProof: 'Prova di autenticità',
			bodyDeclaration: 'Dichiaro sotto giuramento che le informazioni fornite sono corrette e che sono il titolare dei diritti o autorizzato ad agire per conto del titolare dei diritti.',
			bodyDate: 'Data',
		},
		advanced: {
			...
			claimPlaceholder: 'Io, [il tuo nome], per conto di [azienda/persona], notifico che il contenuto in violazione...',
			...
			evidencePlaceholder: 'https://link-alla-tua-opera.com o descrizione...',
		},
		info: {
			title: 'Informazioni importanti',
			l1: 'Tutti gli avvisi DMCA vengono esaminati dal nostro team entro 72 ore.',
			l2: 'Fornire informazioni false può avere conseguenze legali.',
			l3: "Il contenuto può essere rimosso preventivamente durante l'indagine sul reclamo.",
		},
	},
	blog: {
