...
export default {
	...
	admin: {
		...
		communityAds: {
			...
			colRotationHours: '轮换 (小时)',
			colEnabled: '已启用',
			colImpressions: '展示次数',
			colClicks: '点击数',
			noAds: '此状态下没有广告。',
			noStats: '暂无统计数据。',
			statsNote: '显示过去7天的汇总展示次数和点击数。',
			rejectReasonPrompt: '请输入拒绝理由：',
			confirmDeactivate: '停用此广告？',
			toastApproved: '广告已批准。',
			toastRejected: '广告已拒绝。',
			toastDeactivated: '广告已停用。',
			toastWeightSaved: '权重已更新。',
			toastSlotSaved: '位置配置已更新。',
			preview: '预览',
			previewTitle: '广告预览',
		},
	},
	...
	upload: {
		...
		val: {
			avatarGender: '选择虚拟形象性别',
			avatarSize: '选择虚拟形象尺寸',
			avatarType: '选择虚拟形象类型',
			assetType: '选择资源类型',
			platform: '选择平台',
			clothesGender: '选择设计性别',
			clothesType: '选择服装类型',
		},
	},
	cats: {
	...
	meta: {
		...
		avatar: {
			...
			type: '虚拟形象类型 *',
			author: '原作者',
			authorHint: '(虚拟形象创作者名称)',
			authorPlaceholder: '搜索作者... 或输入名称',
			extras: '虚拟形象额外功能',
			authorLinked: '已关联作者 UUID',
		},
		asset: {
			title: '资源详情',
			titleAdmin: '资源元数据',
		...
		clothes: {
			...
			type: '服装类型 *',
			isBase: '是基础（包含基础虚拟形象）',
			baseAvatar: '用于哪个基础虚拟形象？',
			baseAvatarHint: '(自动完成或自由输入)',
			baseAvatarPlaceholder: '搜索基础虚拟形象...',
		},
		clothing_type: {
			title: '服装类型',
			top: '上衣',
	...
	filterPanel: {
		noAssets: '没有找到符合此筛选条件的资产。',
		noAvatars: '没有找到符合此筛选条件的 Avatar。',
		prev: '上一页',
		next: '下一页',
		pagePrefix: '页',
		assetCountStr: '个资产',
		avatarCountStr: '个 Avatar',
		clothesCountStr: '件服装',
		sortLabel: '排序方式',
		titleAssets: 'VRCStorage — 资产',
		titleAvatars: 'VRCStorage — Avatar',
		titleClothes: 'VRCStorage — 服装',
		filterTitle: '筛选',
		reset: '重置筛选',
	},
	autorProfile: {
	...
	community: {
		...
		by: '作者',
		serviceTypes: {
			avatar_creator: 'Avatar 创作者',
			'3d_artist': '3D 艺术家',
			illustrator: '插画师',
			world_builder: '世界建造者',
			texture_artist: '材质艺术家',
			rigger: '绑定师',
			shader_dev: 'Shader 开发者',
			animator: '动画师',
			voice_actor: '配音演员',
			commissioner: '约稿人',
		},
		directory: {
			title: '社区',
			subtitle: '发现 VRChat 创作者和服务',
			allTypes: '所有类型',
			searchPlaceholder: '按名称搜索...',
			noAds: '暂无社区推广。',
			submitAd: '推广自己',
			loginToSubmit: '登录以推广您的服务。',
		},
		detail: {
			notFound: '该推广页面未找到。',
			createTitle: '推广自己',
		...
		budget: {
			btnLabel: '我有广告预算',
			title: '这是一个免费平台。',
			body: 'VRCStorage 不接受广告位付款。所有推广均由社区驱动且免费。如果您希望让更多人看到您的作品，直接提交即可——审核流程对所有人一视同仁。',
			ok: '明白了！',
		},
		prefs: {
			title: '广告偏好',
		...
		form: {
			title: '显示名称',
			titlePlaceholder: '您的名字或品牌...',
			tagline: '标语',
			taglinePlaceholder: '您做什么？（最多 80 个字符）',
			serviceType: '服务类型',
			destType: '目标',
			destInternal: '内部页面（VRCStorage）',
			destExternal: '外部链接',
			externalUrl: '外部 URL',
			description: '页面内容（Markdown）',
			descriptionHint: '显示在您的内部个人主页上。支持 Markdown。',
			descriptionPlaceholder: '告诉大家您的工作...',
			bannerImage: '横幅图片',
			bannerImageHint: '竖版图片，用于侧边栏（推荐 160×196）。',
			cardImage: '卡片图片',
			cardImageHint: '横版图片，用于网格（推荐 400×300）。',
			noImage: '无图片',
			uploadBanner: '上传横幅',
			uploadCard: '上传卡片图片',
			uploading: '上传中...',
			...
			save: '保存更改',
			submitting: '提交中...',
			submitSuccess: '已提交！您的推广正在审核中。',
			updateSuccess: '更新成功。',
			updatedPendingReview: '已更新。重新提交审核。',
			errorTitle: '显示名称为必填项。',
			errorTagline: '标语为必填项。',
			errorServiceType: '请选择服务类型。',
			errorExternalUrl: '外部 URL 为必填项。',
		},
	},
	dmca: {
		simple: {
			...
			optThirdReporter: '第三方（非所有者）',
			reporterName: '身份标识',
			reporterNamePlaceholder: '您的姓名或别名...',
			reporterReason: '举报原因',
			reporterReasonPlaceholder: '请详细描述情况...',
			reason_recognized: '我认识到该内容是另一位创作者的作品',
			reason_shared: '内容在未经原作者许可的情况下被分享',
			reason_asked: '原创作者请我举报',
			reason_paid: '内容未经授权从付费平台获取',
			reason_other: '其他',
			bodyThirdReporterReason: '举报原因',
			representing: '代表组织/工作室',
			...
			optThirdParty: '他人的版权',
			originalOwner: '被认定为',
			ownerPlaceholder: '原创作者姓名...',
			recognizedAs: '被认定为',
			andDemand: '并要求',
			optImmediateTermination: '立即终止该资源',
			optImmediateRemoval: '立即删除该资源',
			optNotifyUser: '通知相关用户',
			resourceUrl: '侵权资源URL：',
			resourceUrls: '侵权资源：',
			resourceUrlsHint: '每行一个链接。',
			proofLabel: '真实性证明（可选）：',
			proofHint: '链接至原始作品或其他证明所有权的证据。',
			proofPlaceholder: 'https://link-to-original-work.com 或描述...',
			preview: '申诉预览：',
			urlNotSpecified: '（未指定URL）',
			bodyI: '我，',
			bodyClaim: '主张vrcstorage.lat上托管的资源',
			bodyInfringe: '侵犯了版权',
			bodyThirdReporterClaim: '举报指定资源中可能存在的版权侵犯。',
			bodyDemand: '因此，我要求：',
			bodyProof: '真实性证明',
			bodyDeclaration: '我在伪证罪的处罚下声明，所提供的信息准确无误，我是权利持有人或经授权代表权利持有人行事。',
			bodyDate: '日期',
		},
		advanced: {
			intro: '请用专业语言填写您的DMCA通知。确保包含所有必要信息。',
			claimLabel: '申诉（请使用专业语言）：',
			claimPlaceholder: '我，[您的姓名]，代表[公司/个人]，特此通知侵权内容...',
			resourcesLabel: '侵权资源：',
			resourcesHint: '粘贴侵权资源的URL（每行一个）：',
			evidenceLabel: '所有权证明：',
			evidenceHint: '证明您对原创内容所有权的URL或描述：',
			evidencePlaceholder: 'https://link-to-your-original-work.com 或描述...',
		title: 'DMCA版权侵权通知',
		subtitle: '举报vrcstorage.lat上托管资源的版权侵权行为',
		modeSimple: '简单模式',
		modeAdvanced: '高级模式',
		sendEmail: '通过邮件发送',
		},
		info: {
			title: '重要信息',
			l1: '所有DMCA通知将由我们的团队在72小时内审核。',
			l2: '提供虚假信息可能会产生法律后果。',
			l3: '在申诉调查期间，内容可能会被预防性地删除。',
		},
},
};
