...
const translations = {
    es: {
        ...
        cats: { avatars: 'Avatares', worlds: 'Mundos', assets: 'Assets', clothes: 'Ropa', others: 'Otros', desc: { avatars: 'Avatares 3D para VRChat', worlds: 'Mundos virtuales para explorar', assets: 'Recursos y herramientas', clothes: 'Ropa y accesorios', others: 'Otros recursos diversos' } },
        wiki: {
    ...
    en: {
        ...
        cats: { avatars: 'Avatars', worlds: 'Worlds', assets: 'Assets', clothes: 'Clothes', others: 'Others', desc: { avatars: '3D avatars for VRChat', worlds: 'Virtual worlds to explore', assets: 'Resources and tools', clothes: 'Clothing and accessories', others: 'Various other resources' } },
        wiki: {
    ...
    ru: {
        ...
        cats: { avatars: 'Аватары', worlds: 'Миры', assets: 'Ассеты', clothes: 'Одежда', others: 'Другое', desc: { avatars: '3D аватары для VRChat', worlds: 'Виртуальные миры для исследования', assets: 'Ресурсы и инструменты', clothes: 'Одежда и аксессуары', others: 'Другие разные ресурсы' } },
        wiki: {
    ...
    jp: {
        ...
        cats: { avatars: 'アバター', worlds: 'ワールド', assets: 'アセット', clothes: '服', others: 'その他', desc: { avatars: 'VRChat用の3Dアバター', worlds: '探索するための仮想ワールド', assets: 'リソースとツール', clothes: '衣服とアクセサリー', others: 'その他のリソース' } },
        wiki: {
            title: 'ウィキ - 依存関係ガイド',
            poiyomi: { title: 'Poiyomi Toon Shader' },
            vrcfury: { title: 'VRCFury' },
    ...
    cn: {
        ...
        cats: { avatars: '虚拟形象', worlds: '世界', assets: '资产', clothes: '服装', others: '其他', desc: { avatars: 'VRChat的3D虚拟形象', worlds: '可探索的虚拟世界', assets: '资源和工具', clothes: '服装和配饰', others: '其他各种资源' } },
        wiki: {
            title: '维基 - 依赖指南',
            poiyomi: { title: 'Poiyomi Toon Shader' },
            vrcfury: { title: 'VRCFury' },
    ...
    fr: {
        ...
        cats: { avatars: 'Avatars', worlds: 'Mondes', assets: 'Actifs', clothes: 'Vêtements', others: 'Autres', desc: { avatars: 'Avatars 3D pour VRChat', worlds: 'Mondes virtuels à explorer', assets: 'Ressources et outils', clothes: 'Vêtements et accessoires', others: 'Autres ressources diverses' } },
        wiki: {
    ...
    pt: {
        ...
        cats: { avatars: 'Avatares', worlds: 'Mundos', assets: 'Assets', clothes: 'Roupas', others: 'Outros', desc: { avatars: 'Avatares 3D para VRChat', worlds: 'Mundos virtuais para explorar', assets: 'Recursos e ferramentas', clothes: 'Roupas e acessórios', others: 'Outros recursos diversos' } },
        wiki: {
